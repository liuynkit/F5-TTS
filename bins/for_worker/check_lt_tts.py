...
def synthesize_speech(text, speed):
    tts_server = "http://192.168.0.68:5057/tts/infer/en_US"
    timeout = None
    try:
        # print('#'*50)
...
def main():
    ...
    speed = "3.0"
    audio_array = synthesize_speech(text, speed)
    if len(audio_array) > 0:
        wave_path = "/project/tts/students/yining_ws/multi_lng/F5-TTS/outputs/worker_output.wav"
