...
speed = args.speed
wave_path = Path(output_dir) / f"infer_en_prompt_de_out_{gen_text[:20]}.wav"
...
def main_process(ref_audio, ref_text, text_gen, model_obj, remove_silence, speed):
    ...
    if generated_audio_segments:
        ...
        # final_wave = remove_silence_for_generated_wav_raw(final_wave)
...
def main():
    ...
    print("speed: ", speed)
    print("#"*50)
    text_seq_list = main_process(ref_audio, ref_text, gen_text, ema_model, remove_silence, speed)
