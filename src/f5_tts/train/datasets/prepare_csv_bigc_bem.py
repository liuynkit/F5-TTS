...
def prepare_csv_wavs_dir(input_dir, num_workers=None):
    ...
    # metadata_path = input_dir / "processed_train.csv"
    metadata_path = input_dir / "processed_valid.csv"
...
def save_prepped_dataset(out_dir, result, duration_list, text_vocab_set, is_finetune):
    ...
    raw_arrow_path = out_dir / "valid_raw.arrow"
...
Examples:
    ...
    python prepare_csv_bigc_bem.py /project/OML/zli/iwslt2025/data/bem/training/bigc/bigc/data/bem/hfdata /project/tts/students/yining_ws/multi_lng/F5-TTS/preprocessed_data/bigc_bem --pretrain --workers 4
            """,
        )
